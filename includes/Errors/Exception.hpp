...
/*   Updated: 2025/10/08 15:07:11 by arthur           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class NosuchChannelException : public RFCException
{
	private:
		std::string message;
		std::string fullMessage;
	...
	public:
		NosuchChannelException(const std::string& arg, std::string clientNick);
